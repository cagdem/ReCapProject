...
namespace ConsoleUI
{
    class Program
    {
        ...
        private static void ProductTest()
        {
            ...
            Console.WriteLine(productManager.GetById(6).CarName +" / "+ productManager.GetById(6).ColorId);
        ...
        private static void BrandTest()
        {
            ...
            Console.WriteLine(brandManager.GetById(5).BrandId + " / " + brandManager.GetById(5).BrandName);
        ...
        private static void ColorTest()
        {
            ...
            Console.WriteLine(colorManager.GetById(6).ColorId + " / " + colorManager.GetById(6).ColorName);
